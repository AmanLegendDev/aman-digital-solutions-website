...
export default function ServiceFeaturesSection({
  ...
  return (
    <ServiceFormSection
      ...
      description="Define the concrete capabilities and deliverables included in this service."
    >
      <div className="space-y-4">
        {fields.length === 0 && (
          <div className="rounded-2xl border border-dashed border-[#292929] bg-[#090909] px-5 py-8 text-center">
            ...
            <p className="mt-1 text-xs text-neutral-600">
              Add the capabilities that make this service
            ...
            >
              ...
              <div className="mb-5 flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  <span className="flex h-8 w-8 items-center justify-center rounded-lg border border-[#242424] bg-[#0D0D0D] text-[10px] font-semibold text-neutral-500">
              ...
              <div className="mt-4">
                ...
                <textarea
                  ...
                  rows={3}
                  maxLength={500}
                  placeholder="A polished experience that works seamlessly across phones, tablets and desktop devices."
        ...
        <p className="pt-1 text-[11px] leading-5 text-neutral-700">
          Features describe what you build or deliver;
          benefits explain why those capabilities matter.
        </p>
      </div>
    </ServiceFormSection>
  );
