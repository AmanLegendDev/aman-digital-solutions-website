            ...
            >
              ...
              >
                <div className="grid gap-6 sm:grid-cols-[auto_1fr_auto] sm:items-start sm:gap-7">
                    ...
                    <div className="flex items-start gap-3">
                      <div className="min-w-0">
                        ...
                        <div className="mt-1 flex items-center gap-2">
                          <h3 className="text-xl font-semibold tracking-[-0.03em] text-[#EAEAEA] transition-colors duration-200 group-hover:text-[#FFC400] sm:text-2xl">
                            {gallery.title}
                          </h3>
                    ...
                    {preview && (
                      <div className="mt-5 overflow-hidden rounded-[20px] border border-[#202020] bg-[#0D0D0D]">
                        <div className="relative aspect-[16/7] overflow-hidden">
                          ...
                          {preview.type ===
                            "video" && (
                            <span className="absolute left-4 top-4 flex h-9 w-9 items-center justify-center rounded-full border border-white/15 bg-black/45 text-white backdrop-blur-md">
                              <Play
                                size={14}
                                fill="currentColor"
                                className="ml-0.5"
                  ...
                  {/* RIGHT SIGNAL */}
                  <div className="hidden items-end self-stretch sm:flex">
