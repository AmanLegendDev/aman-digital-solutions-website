  ...
  return (
    ...
    >
      ...
      <p className="mt-6 max-w-md text-sm leading-7 text-[#858585] sm:text-base sm:leading-7">
        From pricing and timelines to the way we approach
        projects, here are some of the things businesses
      ...
      <div className="mt-9 border-y border-[#202020] py-4">
        <div className="flex items-center gap-3">
          <span className="h-1.5 w-1.5 shrink-0 rounded-full bg-[#FFC400] shadow-[0_0_12px_rgba(255,196,0,0.45)]" />
